        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="navbar-item"><a href="#" class="nav-link">Ver torneos</a></li>
              ...
              <li class="navbar-item"><a href="#" class="nav-link">Ver mis torneos</a></li>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="" class="fas fa-pencil-alt iconos"></a><a href="" class="fas fa-edit iconos"></a></td>
                </tr>
              </tbody>
            </table>
          </table>
